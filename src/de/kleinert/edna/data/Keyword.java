...
public class Keyword implements Comparable<Keyword> {
    ...
    private static final ConcurrentHashMap<Symbol, WeakReference<Keyword>> table = new ConcurrentHashMap<>();
    ...
    public static @Nullable Keyword parse(final @NotNull String s, final boolean allowUTF) {
    ...
    public static @NotNull Keyword parseChecked(final @NotNull String s, final boolean allowUTF) {
        var name = s.startsWith(":") ? s : ":" + s;
        var temp = parse(name, allowUTF);
        if (temp == null) throw new IllegalArgumentException("Illegal keyword format: " + s);
        return temp;
    }
    ...
    public static @NotNull Keyword keyword(final @Nullable String prefix, final @NotNull String name) {
